      ...
      <section className="flex items-center relative z-10">
        <div className={`max-w-4xl mx-auto text-center px-6 py-12 transition-all duration-[900ms] ease-out will-change-[transform,opacity] ${
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://apple.com" target="_blank" rel="noopener noreferrer" className="bg-black text-white px-8 py-4 rounded-2xl flex items-center gap-4 hover:scale-105 transition min-w-[260px] text-left border border-zinc-800">
            ...
            <a href="https://google.com" target="_blank" rel="noopener noreferrer" className="bg-black text-white px-8 py-4 rounded-2xl flex items-center gap-4 hover:scale-105 transition min-w-[260px] text-left border border-zinc-800">
