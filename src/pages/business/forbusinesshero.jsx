  ...
  return (
    <section className="flex flex-col items-center text-center px-6 pt-16 pb-12 max-w-5xl mx-auto font-sans bg-white">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-12">
        <button className="bg-[#0D1B15] text-white px-10 py-3 rounded-full font-bold text-sm shadow-xl shadow-green-900/10 transition-transform active:scale-95">
          {t?.btnPartner}
        </button>
        <button className="bg-white text-[#0D1B15] px-10 py-3 rounded-full font-bold text-sm border border-gray-100 hover:bg-gray-50 transition-all">
          {t?.btnApp}
        </button>
      </div>
