export const businessTranslations = {
  ru: {
    ...
    team: {
      ...
      desc: "Эксперты в медицине, AI и продукте с международным опытом."
    }
  },
  uz: {
    ...
    why: { badge: "BIZNES UCHUN", title: "Nima uchun Sino AI", items: [{ t: "Mijozlarni jalb qiling", d: "Bemorlar qamrovini kengaytiring." }, { t: "Daromad", d: "Yangi obuna modellari." }, { t: "AI-yordamchi", d: "Jarayonlarni soddalashtirish." }] },
  ...
  en: {
    ...
    why: { badge: "BUSINESS", title: "Why choose Sino AI", items: [{ t: "Attract clients", d: "Expand reach." }, { t: "Income", d: "New models." }, { t: "AI helper", d: "Simplify work." }] },
