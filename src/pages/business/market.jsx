...
const Market = () => {
  ...
  return (
    <section id="market" ref={ref} className="py-24 bg-white text-center px-6 font-sans">
      ...
      <h2 className="text-3xl md:text-5xl font-extrabold mb-16 text-[#0D1B15] tracking-tight font-sans">{t?.title}</h2>
      ...
      <div className="grid md:grid-cols-3 gap-10 max-w-5xl mx-auto mb-20">
        {[
          ...
          <div key={i}>
            <div className="text-5xl md:text-6xl font-bold text-[#3E9E67] mb-2 font-sans">
      ...
      <div className="bg-[#F8FAF9] rounded-[40px] p-10 max-w-4xl mx-auto border border-gray-50">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
          {countries.map((c, i) => (
            <div key={i} className="bg-white p-3 rounded-xl flex justify-between items-center shadow-sm border border-gray-50 transition-all">
